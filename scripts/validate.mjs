...
const required = [
  ...
  "public/skills/emailautomationskill/SKILL.md",
  "public/.well-known/skills/emailautomationskill/SKILL.md",
  "public/.well-known/agent-skills/emailautomationskill/SKILL.md",
...
if (!markdown.includes("npx skills add emailautomationskill")) throw new Error("Missing markdown install shortcut");
...
if (indexJson.skills?.[0]?.name !== "emailautomationskill") throw new Error("Invalid well-known skills index");
